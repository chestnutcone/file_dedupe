...
{
    internal class FileDuplicates : IDataHolder<string, List<string>>
    {
        public FileDuplicates()
        {
            Data = new ConcurrentDictionary<string, List<string>>();
        }
        public ConcurrentDictionary<string, List<string>> Data { get; } // key hash, value file paths with same hash
